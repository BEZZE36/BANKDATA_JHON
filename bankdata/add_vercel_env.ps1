#!/usr/bin/env pwsh
# Script untuk menambahkan semua environment variables ke Vercel
# Jalankan dengan: .\add_vercel_env.ps1
...
Write-Host "`n✅ Done! All environment variables have been added." -ForegroundColor Green
Write-Host "Run 'npx vercel --prod' to redeploy." -ForegroundColor Cyan
