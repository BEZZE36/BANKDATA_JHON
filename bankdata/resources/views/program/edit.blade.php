...
<div class="bg-white rounded-2xl border p-6 max-w-3xl">
    <form method="POST" action="{{ route('program.update', $program) }}" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="flex gap-3 pt-4">
            ...
            <a href="{{ route('folder.index', ['modul' => 'program', 'folder' => $program->folder_id]) }}" class="px-5 py-2.5 bg-slate-100 rounded-lg font-medium hover:bg-slate-200 hover:-translate-y-0.5 transition-transform">Batal</a>
        </div>
    </form>
</div>
@endsection
