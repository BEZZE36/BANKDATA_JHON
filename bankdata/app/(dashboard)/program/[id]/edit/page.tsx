...
export default function EditProgramPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    fetch(`/api/program/${id}`)
      ...
      .then(result => {
        if (result.data) {
          ...
          setErrors({ _global: result.message || 'Gagal memuat data program.' });
        }
      })
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setSukses('Data program berhasil diperbarui.');
  ...
  if (fetching) {
    return (
      <div>
        <Header title="Edit Program" breadcrumbs={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Data Program', href: '/program' }, { label: 'Edit' }]} />
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <Input
                  ...
                  name="kode_program"
                  required
                  defaultValue={initialData.kode_program}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <Input
                  ...
                  type="number"
                  required
                  defaultValue={initialData.tahun_anggaran}
                ...
                <Input
                  ...
                  name="unit_pelaksana"
                  required
                  defaultValue={initialData.unit_pelaksana}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <Input
                  ...
                  type="number"
                  required
                  defaultValue={initialData.realisasi}
